...
<body>
        ...
        <?php
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($title == "" || $image == "" || $time == "" || $details == "") {
                    ...
                    $sql = "INSERT INTO tinthethao (titlesport, imagesport, timesport, detailssport) VALUES ('$title', '$image', '$time', '$details')";
    ...
    <div class="main-new">
        <form action="add_sport.php" class="form" method="POST">
            <div class="form-tab">
                <h2>Thêm tin thể thao</h2>
                <a href="add_new.php" class="next-tab" style="text-decoration: none;">Thêm tin mới</a>
            </div>
