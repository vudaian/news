                                ...
                                <?php
                                    ...
                                    <li class="container__content-right-news-item" style="height: 150px;">
                                        ...
                                        <div class="container__content-right-news-item-label" style="width: 75%;">
                                            <h3><a href="index_news.php?titlenew=<?php echo $row['titlenew']; ?>" style="text-decoration: none; color: #000;"><?php echo $row["titlenew"]; ?></a></h3>
                                            <div class="calendar">
                            ...
                            <ul class="container__content-right-list">
                                <?php
                                    ...
                                    <li class="container__content-right-news-item" style="height: 150px;">
                                        ...
                                        <div class="container__content-right-news-item-label" style="width: 75%;">
                                            <h3><a href="index_news.php" style="text-decoration: none; color: #000;"><?php echo $row["titlesport"]; ?></a></h3>
                                            <div class="calendar">
                                                <i class="fa fa-calendar-alt"></i>
