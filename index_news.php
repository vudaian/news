        ...
        <div class="main" style=" padding: 50px;">
            <div class="app" style="display: flex;">
                ...
                <div class="main__content l-9 m-12 c-12">
                        <h1 class="main__content__title"><?php echo $titlenew; ?></h1>
                        <img src="<?php echo $imagenew; ?>" alt="" class="main__content__img">
                        <p class="sub-img"><i>Nguon: Google</i></p>
                        <hr>
                    <div class="main__content__calendar">
                        <i class="fa fa-calendar-alt"></i>
                        <p><?php echo $timenew;  ?></p>
                    </div>
                    <p class="main__content__text"></p>
                </div>
            </div>
            <div class="exchange">
                <div class="recomment">
                ...
                <div class="comment">
                    <form action="index_news.php" method="POST">
